...
def init_PySide6_QtCore():
    ...
    type_map_tuple.update({("PySide6.QtCore.QMetaObject.invokeMethod", "char*"): str})
...
missing_optional_return = {
    ...
    "PySide6.QtWidgets.QMainWindow.menuWidget",
